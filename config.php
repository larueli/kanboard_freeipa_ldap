...
/*                                                                  */
/* MADE BY larueli at GitHub with the help of jdorel for ung.utt.fr */
/********************************************************************/
...
// Set to true in order to connect to FreeIPA LDAP
define('LDAP_AUTH', true);

// FreeIPA LDAP IP
define('LDAP_SERVER', 'change.me.now');
...
// You must create a user who will be only allowed to search : proxy mode
define('LDAP_BIND_TYPE', 'proxy');

// LDAP username to use with proxy mode
define('LDAP_USERNAME', 'uid=CHANGE-ME-NOW-WITH-SEARCH-USER,cn=users,cn=accounts,dc=yourfirstdc,dc=yourdomainextension');

// LDAP password to use for proxy mode
define('LDAP_PASSWORD', 'PasswordOfSearchUser');

// LDAP DN for users
// Example for ActiveDirectory: CN=Users,DC=kanboard,DC=local
// Example for OpenLDAP: ou=People,dc=example,dc=com
define('LDAP_USER_BASE_DN', 'cn=users,cn=accounts,dc=yourfirstdc,dc=yourdomainextension');

// LDAP pattern to use when searching for a user account
// Example for OpenLDAP: 'uid=%s' : we add memberOf kanboard_users, because we don't want all of our users to be able to log in, even in simple user mode
define('LDAP_USER_FILTER', '(&(uid=%s)(memberOf=cn=kanboard_users,cn=groups,cn=accounts,dc=yourfirstdc,dc=yourdomainextension))');
...
define('LDAP_GROUP_ADMIN_DN', 'cn=kanboard_admins,cn=groups,cn=accounts,dc=yourfirstdc,dc=yourdomainextension');

// LDAP DN for managers
// Example: CN=Kanboard Managers,CN=Users,DC=kanboard,DC=local
define('LDAP_GROUP_MANAGER_DN', 'cn=kanboard_managers,cn=groups,cn=accounts,dc=yourfirstdc,dc=yourdomainextension');
...
define('LDAP_GROUP_BASE_DN', 'cn=groups,cn=accounts,dc=uttnetgroup,dc=net');
